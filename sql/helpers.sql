...
-- CRIA TABELA COM SCHEMA DE OUTRA (COM E SEM DADOS)
-- CREATE TABLE public.copy AS TABLE public.table;
-- CREATE TABLE public.copy AS TABLE public.table WITH NO DATA;
